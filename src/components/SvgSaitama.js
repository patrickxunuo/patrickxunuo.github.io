...
export const SvgSaitama = () => {
    ...
    const yRange = useTransform(scrollYProgress, [0.0, 0.07], [0, 1]);
    const pathLength = useSpring(yRange, { stiffness: 400, damping: 90 });


    return (
        <div style={{ background: "var(--black)" }}>
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="50%" height="50%" viewBox="0 0 450.000000 400.000000" preserveAspectRatio="xMidYMid meet">
...
275 314 11 1 44 -5 73 -12z" class="svg-elem-1"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-116 -62 -62 -122 -64 -110 -4 18 89 164 190 174 120z" class="svg-elem-2"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
21z" class="svg-elem-3"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
30 14 c46 22 158 147 143 161 -2 2 -11 -7 -20 -20z" class="svg-elem-4"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
27 -78 60 0 47 74 143 154 202 28 20 34 28 20 28 -10 -1 -49 -31 -86 -68z" class="svg-elem-5"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-5 13 3 -11 17 -156 61 -237 72 -84 10 -217 11 -270 1z" class="svg-elem-6"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-114 93 -203 142 -139 75 -357 145 -449 143 -31 -1 -21 -4 40 -15z" class="svg-elem-7"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
59 15 81 60 90 41 8 168 -4 235 -22z" class="svg-elem-8"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-27 0z" class="svg-elem-9"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
56 228 51 234 -3 2 -6 -2 -9 -10z" class="svg-elem-10"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
272 12 79 68 99 205 70z" class="svg-elem-11"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
8z" class="svg-elem-12"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
0 -7 -4 -4 -10z" class="svg-elem-13"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-157 -19 0 15 47 52 73 43 30 69 78 69 127 0 29 18 70 31 70 4 0 10 -7 13 -16z" class="svg-elem-14"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-28 -57 -5 -10 24 -24 82 -19 82 2 0 28 -12 58 -27z" class="svg-elem-15"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-6 0 -7 -7 -4 -16z" class="svg-elem-16"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-40 -27 6 -10 25 9 61 11 112 7 66 -5 78 -3 100 15 29 25 26 26 -15 7z" class="svg-elem-17"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-115 9 -136 45 -4 7 -11 12 -15 12 -4 -1 -63 -59 -132 -128z" class="svg-elem-18"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
-101 -7 -103 11 -11 47 117 57 200 9 74 9 178 0 157z" class="svg-elem-19"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
74 239 80 275 15 82 6 183 -26 308 -24 92 -44 137 -44 99z" class="svg-elem-20"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
62 60 323 520 315 555 -2 9 -27 -32 -56 -92z" class="svg-elem-21"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
295 0 23 -5 40 -11 40 -8 0 -9 -20 -5 -67z" class="svg-elem-22"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
21 -21 -3 -69 -81z" class="svg-elem-23"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
53 -15 21 -28 32 -28 24z" class="svg-elem-24"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
278 191 290 210 9 15 -8 12 -35 -7z" class="svg-elem-25"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
193 93 298 45 79 55 112 17 59z" class="svg-elem-26"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
11 185 -7 39 -9 42 -14 20z" class="svg-elem-27"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
114 127 -2 -1 -47 -41 -99 -90z" class="svg-elem-28"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
...
149 58 21 -7 22 -6 11 7 -21 25 -71 18 -125 -19z" class="svg-elem-29"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
                    ...
                    style={{
                      pathLength
                    }} d="M286 40 c7 -38 11 -46 20 -38 3 3 -2 21 -10 39 l-16 34 6 -35z" class="svg-elem-30"></motion.path>
                    <motion.path 
                    fill="none"
                    strokeWidth="5"
                    stroke="white"
                    ...
                    style={{
                      pathLength
                    }} d="M4248 3 c6 -2 18 -2 25 0 6 3 1 5 -13 5 -14 0 -19 -2 -12 -5z" class="svg-elem-31"></motion.path>
                </motion.g>
            </svg>
        </div>
    )
